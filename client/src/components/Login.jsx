...
<div className="h-screen w-full text-white bg-cover bg-center" style={{
      ...
      <div className="absolute flex justify-center space-x-36 bottom-0">
       ...
       <img src={a2} class=" h-10 w-auto movele delay1"/>
       <img src={a1} class=" h-10 w-auto movele delay4"/>
       <img src={a4} class="h-10 w-auto movele delay2"/>
       <img src={a1} class="h-10 w-auto movele delay3"/>
       <img src={a4} class="h-10 w-auto movele delay5"/>
       <img src={a3} class="h-10 w-auto movele delay2"/>
        ...
        <div className="rounded h-1/2 w-96 px-8 py-8 drop-shadow-[0_5px_20px_rgba(0,0,0,0.5)]">
            ...
            <form  onSubmit={handleSubmit} class="flex flex-col justify-center items-center">
                <div className="mb-4">
                   ...
                   <input type="text" value={credentials.uname} onChange={onChange} id="uname" name="uname" class="text-center text-black font-body3 text-opacity-50 form-input mt-2 block w-72 h-12 border-gray-300 rounded-md"></input>
                </div>
                <div className="mb-4">
                     <label for="password" className="block text-white text-2xl font-body3 font-medium flex justify-center">PASSWORD</label>
                   <input type="password" value={credentials.password} onChange={onChange} id="password" name="password" class="text-center font-body3 text-black text-opacity-50 form-input mt-2 block w-72 h-12 border-gray-300 rounded-md"></input>
                 </div>
                 <button type="submit" class=" bg-orange-500 text-white px-4 py-2 font-body3 rounded-md transform hover:scale-105 hover:bg-opacity-80 transition duration-150 ease-in-out bounce1">SUBMIT</button>
            </form>
        </div>
    </div>
    </div>
